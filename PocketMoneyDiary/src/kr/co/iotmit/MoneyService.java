...
public class MoneyService {
	static final int pagecount=5;  // 한 페이지에 보여줄 행 개수
	...
	int DefaultScreen() {
		...
		System.out.println("순번   날짜                       항목      내역    금액");
		...
		System.out.println("총지출:" +moneyDAO.Balance());		
		
		System.out.println("숫자를 입력해 주세요(1.수입 2.지출 3.수정 4.삭제) : ");
